...
int main(void)
{
    ...
    EPwm1Regs.TBCTL.bit.CTRMODE = 0b10;  // up-down count
    ...
    // Pulse trigger
    // Vo = 20V, comprised of +24V, -24V alternations
    // D~=0.917
    ...
    // PWM2 triggers - exact opposite of PWM1 - (Vo = Vab)
